...
export const homedata = [
  {
    ...
    class: 'light',
    name: 'About Me',
    text: 'Coming from the high mountains of Austria, I washed ashore on a Dutch North Sea island. Not only did I switch my Apfelstrudel for Appeltaart - I also switched my profession from being a metrologist in the automotive industry to following my passion for creating awesome things on the Web.',
    image: about,
    linkto: '/aboutme',
  },
  {
