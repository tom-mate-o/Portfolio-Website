...
export const homedata = [
  {
    ...
    class: 'light',
    name: 'About Me',
    text: 'Coming from the high mountains of Austria, I washed ashore on an island in the Dutch North Sea. Not only that, I switched my Apfelstrudel for Appeltaart. I also switched my profession from being a meteorologist in the automotive industry to following my passion for creating awesome things on the Web.',
    image: about,
    linkto: '/aboutme',
  },
  {
  ...
  },
  {
    ...
    class: 'light',
    name: 'Art',
    text: 'Art is a huge word. I would not describe myself as an artist, but as creative.<br/>I like to draw, scribble, and paint whenever I can.<br/>Click here to see some of my latest work.',
    image: art,
    linkto: '/art',
  },
];
